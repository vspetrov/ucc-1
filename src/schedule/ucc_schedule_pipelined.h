...
ucc_status_t ucc_schedule_pipelined_init(ucc_base_coll_args_t *coll_args,
                                         ...
                                         ucc_schedule_frag_finalize_fn_t  frag_finalize, //do we need frag finalize ?? just use finalize from task ? TODO
                                         ucc_schedule_frag_setup_fn_t frag_setup,
                                         int n_frags,
                                         int n_frags_total,
                                         ucc_schedule_pipelined_t **schedule_p);

ucc_status_t ucc_schedule_frag_init(ucc_schedule_frag_t *schedule, ucc_coll_args_t *args,
