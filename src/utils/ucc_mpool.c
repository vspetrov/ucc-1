...
static ucs_status_t ucc_mpool_chunk_alloc_wrapper(ucs_mpool_t *mp,
                                                  size_t *size_p,
                                                  void **chunk_p)
{
                            ...
                            const char *name)
{
    ...
    return ucs_status_to_ucc_status(ucs_mpool_init(
        &mp->super, priv_size, elem_size, align_offset, alignment,
        elems_per_chunk, max_elems, ucs_ops, name));
